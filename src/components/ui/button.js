...
const buttonStyles = cva("inline-flex items-center justify-center rounded-2xl text-sm font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed interactive relative overflow-hidden", {
    variants: {
        variant: {
...
export function Button({ className, variant, size, ...props }) {
    return _jsx("button", { className: clsx(buttonStyles({ variant, size }), className), ...props });
}
